...
use Aheadworks\Popup\Model\ThirdPartyModule\PageBuilder\PageBuilderService;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset(
            ...
            $this->getLayout()->createBlock(Fieldset::class
        ...
        if ($this->pageBuilderService->isBuilderEnabled()) {
            $fieldset->addField(
                '_content',
                'hidden',
                [
