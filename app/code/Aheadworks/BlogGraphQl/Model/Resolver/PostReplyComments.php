...
class PostReplyComments implements ResolverInterface
{
    /**
    ...
    public function resolve(
        ...
        if (!is_null($storeId) && !is_null($postId)) {
            $result = $this->commentProvider->getChildComments($data);
        }
    ...
    {
        $data = [];
        $data[Resolver::PARENT_COMMENT_ID] = $args['rootCommentId'];
        ...
        $data[Resolver::CHILD_COMMENT_QTY] = $args['pageSize'];
