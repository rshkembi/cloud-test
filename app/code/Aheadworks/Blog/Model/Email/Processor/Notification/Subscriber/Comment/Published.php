...
class Published extends AbstractProcessor
{
    /**
    ...
    protected function isNeedToNotifyRecipient($updatedEntity, $originalEntity = null): bool
    {
        return $originalEntity !== null
            && $this->commentChecker->isPublished($originalEntity, $updatedEntity);
    }
    ...
    {
        return $this->config->getNotificationTemplateForSubscriberAboutCommentIsPublished(
    ...
    {
        return EmailQueueItemTypeSourceModel::SUBSCRIBER_COMMENT_PUBLISHED;
    }
}
