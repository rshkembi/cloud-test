...
namespace Aheadworks\Blog\Model\Email\Processor\Notification\Subscriber\Comment;
...
class Rejected extends AbstractProcessor
{
    /**
    ...
    protected function isNeedToNotifyRecipient($updatedEntity, $originalEntity = null): bool
    {
        return $originalEntity !== null
            && $this->commentChecker->isRejected($originalEntity, $updatedEntity);
    }
    ...
    {
        return $updatedEntity->getStoreId();
    }
    ...
    {
        return $this->config->getNotificationTemplateForSubscriberAboutCommentIsRejected(
    ...
    {
        return EmailQueueItemTypeSourceModel::SUBSCRIBER_COMMENT_REJECTED;
    }
}
