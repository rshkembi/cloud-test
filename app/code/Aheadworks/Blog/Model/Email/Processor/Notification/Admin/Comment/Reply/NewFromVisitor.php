...
namespace Aheadworks\Blog\Model\Email\Processor\Notification\Admin\Comment\Reply;
...
class NewFromVisitor extends AbstractProcessor
{
    ...
    {
        return !empty($this->getNotificationTemplate((int)$updatedEntity->getStoreId()));
    }
    ...
    {
        return EmailQueueItemTypeSourceModel::ADMIN_NEW_REPLY_COMMENT_FROM_VISITOR;
    }
}
