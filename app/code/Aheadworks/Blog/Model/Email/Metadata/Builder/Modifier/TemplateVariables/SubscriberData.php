...
class SubscriberData implements ModifierInterface
{
    /**
    ...
    public function addMetadata(
        ...
        $templateVariables['subscriber_name'] = $emailQueueItem->getRecipientName();
        $templateVariables['subscriber_email'] = $emailQueueItem->getRecipientEmail();
