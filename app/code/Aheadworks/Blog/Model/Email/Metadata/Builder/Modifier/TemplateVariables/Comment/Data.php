...
class Data implements ModifierInterface
{
    ...
    public function addMetadata(
        ...
        $comment = $this->getComment($emailQueueItem);
        $templateVariables['comment_content'] = $comment->getContent();
        $templateVariables['comment_author_name'] = $comment->getAuthorName();
        $templateVariables['comment_author_email'] = $comment->getAuthorEmail();
     ...
     */
    protected function getComment(EmailQueueItemInterface $emailQueueItem): CommentInterface
    {
