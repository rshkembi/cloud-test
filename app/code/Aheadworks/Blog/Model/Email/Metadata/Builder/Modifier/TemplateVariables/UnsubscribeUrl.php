...
namespace Aheadworks\Blog\Model\Email\Metadata\Builder\Modifier\TemplateVariables;
...
class UnsubscribeUrl implements ModifierInterface
{
    /**
    ...
    public function addMetadata(
        ...
        $securityCode = $emailQueueItem->getSecurityCode();
        $templateVariables['unsubscribe_url'] =
            $this->frontendUrlBuilder->getSubscriberEmailNotificationSettingsUrl(
                $securityCode,
                [],
