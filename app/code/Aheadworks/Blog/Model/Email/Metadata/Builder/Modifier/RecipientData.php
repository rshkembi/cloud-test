...
class RecipientData implements ModifierInterface
{
    /**
    ...
    public function addMetadata(
        ...
        $emailMetadata->setRecipientName($emailQueueItem->getRecipientName());
        $emailMetadata->setRecipientEmail($emailQueueItem->getRecipientEmail());
